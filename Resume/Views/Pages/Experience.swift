                ...
                ZStack{
                    ...
                    VStack{
                        VStack{
                            ...
                            Text("Freelance | October 2021 - Currently").font(.system(size: 16)).multilineTextAlignment(.center).padding(.horizontal)
                        }
                ...
                ZStack{
                    ...
                    VStack{
                        VStack{
                            ...
                            Text("Satoshitango | October 2021 - Currently").font(.system(size: 16)).multilineTextAlignment(.center).padding(.horizontal)
                        }
